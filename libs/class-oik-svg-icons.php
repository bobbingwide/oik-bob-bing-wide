...
if ( !defined( 'CLASS_OIK_SVG_ICONS_INCLUDED' ) ) {
    ...
    class OIK_SVG_icons
    {
        ...
        function list_svg_icons() {
            ...
            $icons['admin-page']
                = 'M6 15V2h10v13H6zm-1 1h8v2H3V5h2v11z';
            ...
            $icons['align-center']
                = 'M3 5h14V3H3v2zm12 8V7H5v6h10zM3 17h14v-2H3v2z';

            $icons['align-full-width']
                = 'M17 13V3H3v10h14zM5 17h10v-2H5v2z';

            $icons['align-left']
                = 'M3 5h14V3H3v2zm9 8V7H3v6h9zm2-4h3V7h-3v2zm0 4h3v-2h-3v2zM3 17h14v-2H3v2z';

            $icons['align-none']
                = 'M3 5h14V3H3v2zm10 8V7H3v6h10zM3 17h14v-2H3v2z';

            $icons['align-right']
                = 'M3 5h14V3H3v2zm0 4h3V7H3v2zm14 4V7H8v6h9zM3 13h3v-2H3v2zm0 4h14v-2H3v2z';

            $icons['align-wide']
                = 'M5 5h10V3H5v2zm12 8V7H3v6h14zM5 17h10v-2H5v2z';
            ...
            $icons['archive']
                = 'M19 4v2H1V4h18zM2 7h16v10H2V7zm11 3V9H7v1h6z';
            /*
            ...
            */
            ...
            $icons['arrow-down-alt']
                = 'M9 2h2v12l4-4 2 1-7 7-7-7 2-1 4 4V2z';

            $icons['arrow-down-alt2']
                = 'M5 6l5 5 5-5 2 1-7 7-7-7z';

            $icons['arrow-down']
                = 'M15 8l-4.03 6L7 8h8z';

            $icons['arrow-left-alt']
                = 'M18 9v2H6l4 4-1 2-7-7 7-7 1 2-4 4h12z';

            $icons['arrow-left-alt2']
                = 'M14 5l-5 5 5 5-1 2-7-7 7-7z';

            $icons['arrow-left']
                = 'M13 14L7 9.97 13 6v8z';

            $icons['arrow-right-alt']
                = 'M2 11V9h12l-4-4 1-2 7 7-7 7-1-2 4-4H2z';

            $icons['arrow-right-alt2']
                = 'M6 15l5-5-5-5 1-2 7 7-7 7z';

            $icons['arrow-right']
                = 'M8 6l6 4.03L8 14V6z';

            $icons['arrow-up-alt']
                = 'M11 18H9V6l-4 4-2-1 7-7 7 7-2 1-4-4v12z';

            $icons['arrow-up-alt2']
                = 'M15 14l-5-5-5 5-2-1 7-7 7 7z';

            $icons['arrow-up']
                = 'M7 13l4.03-6L15 13H7z';
            ...
            $icons['buddicons-buddypress-logo']
            ...
            $icons['chart-bar']
                = 'M18 18V2h-4v16h4zm-6 0V7H8v11h4zm-6 0v-8H2v8h4z';
            ...
            $icons['cloud']
                = 'M14.85 10.03c1.76.18 3.15 1.66 3.15 3.47 0 1.93-1.57 3.5-3.5 3.5h-10C2.57 17 1 15.43 1 13.5c0-1.79 1.34-3.24 3.06-3.46C4.02 9.87 4 9.69 4 9.5 4 8.12 5.12 7 6.5 7c.34 0 .66.07.95.19C8.11 5.89 9.45 5 11 5c2.21 0 4 1.79 4 4 0 .36-.06.7-.15 1.03z';

            $icons['columns']
                = 'M3 15h6V5H3v10zm8 0h6V5h-6v10z';

            $icons['controls-back']
                = 'M2 10l10-6v3.6L18 4v12l-6-3.6V16z';

            $icons['controls-forward']
                = 'M18 10L8 16v-3.6L2 16V4l6 3.6V4z';

            $icons['controls-pause']
                = 'M5 16V4h3v12H5zm7-12h3v12h-3V4z';

            $icons['controls-play']
                = 'M5 4l10 6-10 6V4z';

            $icons['controls-repeat']
                = 'M5 7v3l-2 1.5V5h11V3l4 3.01L14 9V7H5zm10 6v-3l2-1.5V15H6v2l-4-3.01L6 11v2h9z';

            $icons['controls-skipback']
                = 'M11.98 7.63l6-3.6v12l-6-3.6v3.6l-8-4.8v4.8h-2v-12h2v4.8l8-4.8v3.6z';

            $icons['controls-skipforward']
                = 'M8 12.4L2 16V4l6 3.6V4l8 4.8V4h2v12h-2v-4.8L8 16v-3.6z';

            $icons['controls-volumeoff']
                = 'M2 7h4l5-4v14l-5-4H2V7z';
            ...
            $icons['download']
                = 'M14.01 4v6h2V2H4v8h2.01V4h8zm-2 2v6h3l-5 6-5-6h3V6h4z';
            ...
            $icons['editor-break']
                = 'M16 4h2v9H7v3l-5-4 5-4v3h9V4z';

            $icons['editor-code']
                = 'M9 6l-4 4 4 4-1 2-6-6 6-6zm2 8l4-4-4-4 1-2 6 6-6 6z';

            $icons['editor-contract']
            ...
            $icons['flag']
                = 'M5 18V3H3v15h2zm1-6V4c3-1 7 1 11 0v8c-3 1.27-8-1-11 0z';
            ...
            $icons['heading']
                = 'M12.5 4v5.2h-5V4H5v13h2.5v-5.2h5V17H15V4';
            ...
            $icons['leftright']
                = 'M3 10.03L9 6v8zM11 6l6 4.03L11 14V6z';
            ...
            $icons['media-default']
                = 'M12 2l4 4v12H4V2h8zm0 4h3l-3-3v3z';

            $icons['media-document']
            ...
            $icons['menu-alt']
                = 'M3 4h14v2H3V4zm0 5h14v2H3V9zm0 5h14v2H3v-2z';

            $icons['menu']
                = 'M17 7V5H3v2h14zm0 4V9H3v2h14zm0 4v-2H3v2h14z';
            ...
            $icons['migrate']
                = 'M4 6h6V4H2v12.01h8V14H4V6zm2 2h6V5l6 5-6 5v-3H6V8z';
            ...
            $icons['plus-light']
                = 'M17 9v2h-6v6H9v-6H3V9h6V3h2v6h6z';

            $icons['plus']
                = 'M17 7v3h-5v5H9v-5H4V7h5V2h3v5h5z';
            ...
            $icons['saved']
                = 'M15.3 5.3l-6.8 6.8-2.8-2.8-1.4 1.4 4.2 4.2 8.2-8.2';
            ...
            $icons['shield-alt']
                = 'M10 2s3 2 7 2c0 11-7 14-7 14S3 15 3 4c4 0 7-2 7-2z';
            ...
            $icons['upload']
                = 'M8 14V8H5l5-6 5 6h-3v6H8zm-2 2v-6H4v8h12.01v-8H14v6H6z';
            ...
            $icons['flickr']
                = 'M6.5,7c-2.75,0-5,2.25-5,5s2.25,5,5,5s5-2.25,5-5S9.25,7,6.5,7z M17.5,7c-2.75,0-5,2.25-5,5s2.25,5,5,5s5-2.25,5-5 S20.25,7,17.5,7z';
            return $icons;
        }
